...
export const FACULTY: FacultyMember[] = [
  {
    name: 'Professor Sir Nigel Shadbolt',
    role: 'Principal, Jesus College, Oxford; Professor of Computing Science, Oxford; Chair, AI@Oxford Research',
    image: '/faculty/sir-nigel.jpg',
    bio: [
      ...
      '\nSailing, running, gardening, wine and collecting.\n\n',
      { highlight: 'Honours' },
